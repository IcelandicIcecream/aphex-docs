...
An installation may also configure [`upload.allowedMimeTypes`](/configuration#upload). Files
...
the owning organization, or presents a [signed URL](/storage#signed-urls) — which is how you
