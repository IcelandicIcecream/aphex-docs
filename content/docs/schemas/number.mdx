...
<Callout>
Number fields are ideal for **driving styles** — read the value in your frontend and bind it to a CSS variable or inline style (e.g. `padding`, `opacity`). Numbers pass straight through; with [visual editing](/docs/visual-editing) the layout updates live as you drag the slider. (String fields used in CSS need `stegaClean` first — see that guide.)
</Callout>
